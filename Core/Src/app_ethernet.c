...
//                    printf("**********************************\n");
//                    printf("*** DHCP*IP   : %u.%u.%u.%u\r\n", ip4_addr1(netif_ip4_addr(netif)), ip4_addr2(netif_ip4_addr(netif)), ip4_addr3(netif_ip4_addr(netif)), ip4_addr4(netif_ip4_addr(netif)));
//                    printf("*** TIME need : %lu.%03lu sec\n", currentTime / 1000, currentTime % 1000);
//                    printf("**********************************\n");
//
                    ppIP(netif->ip_addr.addr);
//                    pp_string("Time need :");
                    //pp_uint("");
