...
void init_watchdog ()
{
    ...
    hiwdg.Init.Prescaler = IWDG_PRESCALER_64; // Prescaler-Wert
    hiwdg.Init.Reload = 2047;                  // Reload-Wert
    hiwdg.Init.Window = IWDG_WINDOW_DISABLE;  // Optional: Window-Modus deaktivieren

//    hiwdg.Init.Reload = milliseconds_for_watchdog(2000);
    ...
    ppc("Watchdog barking at ~4 seconds");
}
