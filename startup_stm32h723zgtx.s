...
/**
 * @brief  Hard Fault Handler to set red LED (PB14) permanently on for debugging.
 * @param  None
 * @retval None
*/
    .section  .text.HardFault_Handler,"ax",%progbits
HardFault_Handler:
    /* GPIO Clock für Port B aktivieren (RCC_AHB4ENR) */
    ldr r0, =0x50000000 /* RCC base address */
    ldr r1, [r0, #0x4C] /* RCC_AHB4ENR */
    orr r1, r1, #0x2    /* Bit 1 für GPIOB */
    str r1, [r0, #0x4C]

    /* PB14 als Output konfigurieren (GPIOB_MODER) */
    ldr r0, =0x40020400 /* GPIOB base address */
    ldr r1, [r0, #0x00] /* GPIOB_MODER */
    bic r1, r1, #(0x3 << 28) /* Clear bits 28-29 für PB14 */
    orr r1, r1, #(0x1 << 28) /* Set bit 28 für Output */
    str r1, [r0, #0x00]

    /* PB14 auf High (rote LED an, GPIOB_BSRR) */
    ldr r1, =0x4000     /* Set PB14 (1 << 14) */
    str r1, [r0, #0x18] /* GPIOB_BSRR */
